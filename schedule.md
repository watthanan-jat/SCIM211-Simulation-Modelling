# SCIM211 Course Schedule

## Semester 1, Academic Year 2026

Regular sessions are scheduled for **10:00–12:00**.

- Tuesday sessions focus on theory, modelling, demonstrations, and guided activities.
- Designated Wednesday sessions are used for labs or the Project Challenge.
- Lecture notes, announcements, approved schedule changes, and submission instructions will be posted in Google Classroom.

Teaching begins on **Tuesday 4 August 2026**. There is no regular class during **midterm week, 28 September–2 October**.
...
1. Map the real system and build a first simulation.
2. Generate and investigate pseudo-random numbers.
3. Transform random numbers into realistic model inputs.
4. Use Monte Carlo experiments to compare profit and promotion decisions.
5. Build a discrete-event coffee-shop queue.
6. Model customer loyalty using Markov chains.
7. Validate the model and develop a defensible recommendation.

In Week 16, groups apply the model they have built to an assigned Project Challenge.

## Important Notes

- The timetable may be adjusted when required by the University calendar.
- Google Classroom is the official source for approved changes to dates, rooms, activities, or submission arrangements.
- Students are responsible for checking Google Classroom regularly.
- The final examination date will be announced according to the Faculty examination timetable.
